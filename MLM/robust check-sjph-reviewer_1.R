# robust analysis
# exclude the urban hukou, living in rural regions
# 14th July, 2026
...
# Predictors
lapply(mlm_2015[, c("hukou", "residency",
  "urban_rural", "education", "pche_quartile", "gender", "marital", "age_group")], table)

mlm_2015 <- mlm_2015 %>%
  filter(!(hukou == 1 & residency == 0))
table(mlm_2015$hukou, mlm_2015$residency)
...
# VIF
check_collinearity(model.hypertension_pre_2015)
...
# VIF
check_collinearity(model.diabetes_pre_2015)
...
# VIF
check_collinearity(model.dyslipidemia_pre_2015)
...
# VIF
check_collinearity(model.hypertension_sr_2015)
...
# VIF
check_collinearity(model.diabetes_sr_2015)
...
# VIF
check_collinearity(model.dyslipidemia_sr_2015)
